...
const weeklyReports: WeekReport[] = [
  { id: "week15", week: 15, dateRange: "Nov 23 – 29, 2025", status: "on-track", statusEmoji: "✅", executiveSummary: "Slower progress on project deliverables, along with the final packet, is mostly complete, and project closure deadlines are approaching soon. From this week on, I will focus on my roadmap items to ensure they are reasonable and align with my goals, and begin planning for these items before semester closure. I continued to monitor Handshake for new internship positions and may broaden my scope even further for a broader range of opportunities; however, similar to my roadmap items, this initiative is still in its early stages of planning. Regarding stakeholder interactions, I completed and documented feedback on mock/practice interviews, gaining a brief understanding of the behavioral questions I may face in future interviews throughout my career.", accomplishments: ["Documented feedback regarding mock/practice interviews from stakeholders", "Reviewed project deliverables completion and initiated lessons learned based on completion and obstacles", "Reviewed roadmap items, began planning, and analyzed more potential, reasonable roadmap items (if necessary)", "Completed parts of the Closure Documents and reviewed project execution phases to ensure this document is authentic and personal"], issuesRisks: { issues: "Challenging to complete the project closure document due to the lack of completion of project deliverables.", risks: "Peer reviews were not initiated despite the deadline being within a couple of days.", mitigation: "Communicate with stakeholders who've seen and heard about my project charter for guidance to ensure closure document is authentic. Communicate with stakeholders (classmates) to request peer reviews and, in return, review their project progress." }, plansNextWeek: ["Complete Closure Document", "Initiate Peer Reviews", "Continue Monitoring Handshake for New Internship", "Review Roadmap Items (Initiation Phase)", "Thanking Stakeholders"], upcomingMilestones: ["Project Closure Document – 12/9/2025: On Track", "Peer Reviews – TBD: Pending", "Roadmap Initiation Phase – 12/9/2025: On Track"], changeSinceLastReport: "No changes to report.", projectHealth: "🟢 On Track", reflection: "This week's progress slowed down even further than in week 14, and the main reason is due to Thanksgiving week, so motivation and focus on my project were bound to be low for most of the time. However, final packet deliverables remained steady, and I got the opportunity to hold interviews, both as the interviewer and as an interviewee. This experience provided additional motivation to plan my project for the next semester, as stakeholders congratulated me on my achievements throughout the project timeline, including accomplishments I hadn't given myself credit for. Additionally, I received feedback regarding personal confidence and pushing myself outside my comfort zone from these interviews, which influenced me to review my roadmap items. Communication with new stakeholders has become easier for me as I now have a consistent approach to initiating conversations. Ultimately, my goal for meeting new stakeholders, both professional and personal, is to maintain a relationship, as I tend to avoid creating new ones that die out within a couple of weeks. The more authentic stakeholders I meet, the more confidence and insight I will gain regarding the job process, which will boost my chances of applying and landing an internship position; all achieved by expanding my social circle and communicating effectively." },
  { id: "week14", week: 14, dateRange: "Nov 16 – 22, 2025", status: "at-risk", statusEmoji: "⚠️", executiveSummary: "A few weeks before the project's complete closure, I still find myself executing major deliverables; however, the workload is minimal and more focused on ensuring the quality of the deliverables is high. Continuing to search for available positions and reaching out to stakeholders, especially peers in my majors, for advice on finding positions, learning the reality when it comes to application documents, and strengthening communication skills for future opportunities during networking events. Furthermore, I'm communicating with new stakeholders, maintaining the relationship by keeping in contact, and briefly explaining the personal and professional values of my project (involves personal conversation, rather than a professional one).", accomplishments: ["Constructed and Completed Star Stories for Practice", "Scheduled Stakeholder Interview to Satisfy Project Deliverables", "Looking out for Positions on Handshake (roadmap alignment)"], issuesRisks: { issues: "Bit-Sized Lessons Not Initiated—Due to focusing on other coursework and other parts of the final packet, this assignment flew over my head, and now, I'm finding myself starting this assignment a week before it's due.", risks: "Limited time remaining before bite-sized lesson deadline may impact quality of deliverable.", mitigation: "Reduce time from other courses and parts of the final packets to complete this small, but meaningful assignment." }, plansNextWeek: ["Execute Stakeholder Interview", "Initialize Project Closure Document", "Execute Bit-Sized Lesson", "Review of Deliverables Progress and Results"], upcomingMilestones: ["Record Interviewees – 11/29/2025: At Risk", "Bite-Sized Lessons – 11/26/2025: At Risk", "Closure Documents – 12/6/2025: On Track"], changeSinceLastReport: "No changes to report.", projectHealth: "🟡 At Risk", reflection: "This week, I found myself communicating with new stakeholders, despite the project nearing its close. I met my deliverable requirements of expanding my network by at least 2 LinkedIn connections, but I completely overlooked how many new people I've met in person. I also found myself indirectly joining new clubs and explaining my semester-long project, as well as the personal and professional reasons that motivated me to choose this project topic. Besides strengthening my stakeholder communication and expanding my social circle, I'm maintaining a constant lookout for a position, as many internships are for Summer 2026. Due to this project, I feel more confident in applying in the near future, after the project and semester closure. Furthermore, I had the opportunity to practice writing star stories and how they relate to the question. This experience allowed me to truly analyze my strengths, especially my small accomplishments, and turn them into written words that demonstrate significant growth and meaning, as I often overlook small achievements in my life. Additionally, writing out star stories allowed me to refine my interviewing skills for future interviews and provided insight into behavioral questions that I might encounter." },
