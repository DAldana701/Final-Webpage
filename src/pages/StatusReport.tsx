...
const weeklyReports: WeekReport[] = [
  { id: "week13", week: 13, dateRange: "Nov 9 – 15, 2025", status: "at-risk", statusEmoji: "⚠️", executiveSummary: "This week marks a critical juncture as final deliverable deadlines approach. While significant progress was made on documentation refinement and website design, certain time-sensitive assignments—specifically stakeholder interviews and bite-sized lesson recordings—remain incomplete. These deliverables carry fixed deadlines requiring immediate prioritization and accelerated execution. Notable achievements include completing two STAR stories, overhauling the status report interface, and designing a modernized central website. Moving forward, strategic time allocation and proactive stakeholder outreach will be essential to ensure all remaining deliverables meet quality standards within established timelines.", accomplishments: ["Completed 2 of 5 STAR behavioral interview stories", "Updated and refined the status report web page with enhanced design elements", "Designed a new, high-quality central website with modern UI/UX principles"], issuesRisks: { issues: "Bite-sized lesson recordings have not been initiated due to competing coursework priorities and attention directed toward other final packet components. This delay presents a significant risk given the one-week timeline remaining before submission.", risks: "Stakeholder interview scheduling has proven challenging as several selected interviewees face their own final examinations and major project deadlines, creating availability conflicts that may impact timely completion.", mitigation: "Time will be reallocated from other coursework and final packet components to prioritize completion of bite-sized lessons. Continued outreach to alternative stakeholders is underway, with contingency plans to identify new interviewees who have confirmed availability within the two-week window." }, plansNextWeek: ["Complete remaining STAR behavioral interview stories", "Contact and schedule confirmed interviews with selected stakeholders", "Initialize closure documentation to capture project insights and lessons learned", "Continue targeted job search activities aligned with career roadmap", "Begin recording bite-sized lesson content"], upcomingMilestones: ["Record Stakeholder Interviewees – 11/29/2025: At Risk", "Finalize Central Website Design – 11/29/2025: On Track", "Submit Bite-Sized Lessons – 11/26/2025: At Risk", "Complete Closure Documents – 11/29/2025: On Track"], changeSinceLastReport: "The project website is now accessible via the Lovable platform link, with GitHub serving as the repository host for project information and version control. A comprehensive layout and structural redesign has been implemented for the final webpage deliverable, incorporating modern design principles and improved user experience.", projectHealth: "🟡 At Risk", reflection: "This week served as a humbling reminder of the delicate balance required when managing multiple high-stakes deliverables simultaneously. While I take pride in the visual and structural improvements made to the website and status reports, I must acknowledge that I allowed certain critical assignments to slip through the cracks. The realization that bite-sized lessons and stakeholder interviews were approaching their deadlines faster than anticipated created genuine stress—not because the work is insurmountable, but because I hold myself accountable for awareness I possessed from the outset. There is no external factor to blame; these were known commitments I simply did not prioritize effectively. That said, this challenge has reinforced valuable lessons about the difference between productive perfectionism and counterproductive procrastination. The coming week will test my ability to execute under pressure while maintaining quality standards. I am confident in my capacity to deliver, but this experience will undoubtedly influence how I approach deadline management in future professional settings." },
