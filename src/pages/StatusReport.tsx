...
const weeklyReports: WeekReport[] = [
  { id: "week13", week: 13, dateRange: "Nov 9 – 15, 2025", status: "at-risk", statusEmoji: "⚠️", executiveSummary: "As some of the final packets' deadlines are approaching, I have realized that I haven't been on top of completing the assignments that are due within the next week or so. Furthermore, these deadlines are set in stone, so I will have to prioritize and execute these deliverables in a fast but high-quality manner. Specifically, the stakeholder interviews and recording of both the interviews and the bite-sized lessons are at risk of late submission. With this in mind, it has put me under some stress, but I understand that there is no excuse, as I was aware of the deadlines from the start of November. On the bright side, the text and design overhaul on the project charter and status reports are completed, along with some of the STAR stories.", accomplishments: ["Completed 2/5 STAR stories", "Updated and refined the status report web page", "Designed a new, high-quality central website"], issuesRisks: { issues: "Bit-Sized Lessons Not Initiated – Due to focusing on other coursework and other parts of the final packet, this assignment flew over my head, and now, I'm finding myself starting this assignment a week before it's due.", risks: "Stakeholder Interview Scheduling Difficult – Due to some of the stakeholders also having finals and big projects, I am struggling to schedule interviews with the selected interviewees.", mitigation: "Reduce time from other courses and parts of the final packets to complete this small, but meaningful assignment. Continue reaching out for potential alternatives or find new stakeholders that (I believe) are free to conduct the interview within the next two weeks." }, plansNextWeek: ["Complete Remaining STAR Stories", "Contact Selected Interviewee / Schedule Interview", "Initialize The Closure Document", "Continue Job Searching (Roadmap Alignment)", "Initialize Bit-Sized Lessons Recording"], upcomingMilestones: ["Record Interviewees – 11/29/2025: At Risk", "Finalize Central Website Design – 11/29/2025: On Track", "Bite-Sized Lessons – 11/26/2025: At Risk", "Closure Documents – 11/29/2025: On Track"], changeSinceLastReport: "The website is now accessible by clicking on the Lovable link; however, GitHub hosts the repository for information about my Lovable website. Designed a new layout and structure for my final webpage deliverable.", projectHealth: "🟡 At Risk", reflection: "This week highlighted the importance of time management and staying ahead of deadlines, even when juggling multiple commitments. While I made significant progress on visual design and STAR stories, I fell behind on critical deliverables like bite-sized lessons and stakeholder interviews. The stress of approaching deadlines served as a wake-up call to re-prioritize and focus on execution. Moving forward, I need to balance perfectionism with pragmatism—delivering quality work within realistic timeframes rather than letting tasks accumulate. Despite the challenges, completing the website redesign and status report updates demonstrates my ability to deliver when focused. The next week will require discipline and clear prioritization to ensure all final deliverables are completed on time." },
